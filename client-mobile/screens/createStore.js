            ...
            const response = await fetch(
                "https://036e-2001-448a-10b0-3db1-5032-3503-3f18-bfb6.ngrok-free.app/stores",
                {
                    headers: {
                        ...
                        Authorization:
                            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NWE3ZDVkZWU5MzVjZjc3MzAwODg2OGEiLCJlbWFpbCI6ImFkbWluQGdtYWlsLmNvbSIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcwNTg1OTkxNX0.f7kC6Zl5rr5u7JP9SB36mmdbU01QIED3EYpp091Yx1s",
                    },
                    method: "POST",
                    body: formData,
                }
